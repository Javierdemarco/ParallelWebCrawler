 ...
 *
 * <p>TODO: Reimplement the sort() method using only the Stream API and lambdas
 * and/or method references.
 */
final class WordCounts {

  /**
   * Given an unsorted map of word counts, returns a new map whose word counts
   * are sorted according to the provided {@link WordCountComparator}, and
   * includes only the top
   * {@param popluarWordCount} words and counts.
   *
   * <p>TODO: Reimplement this method using only the Stream API and lambdas
   * and/or method references.
   *
   * @param wordCounts       the unsorted map of word counts.
   * @param popularWordCount the number of popular words to include in the
   *     result map.
   * @return a map containing the top {@param popularWordCount} words and counts
   *     in the right order.
   */
  static Map<String, Integer> sort(Map<String, Integer> wordCounts,
                                   int popularWordCount) {

    // TODO: Reimplement this method using only the Stream API and lambdas
    // and/or method references.
    ...
    return wordCounts.entrySet()
        .stream()
        .sorted((p1, p2) -> (new WordCountComparator().compare(p1, p2)))
